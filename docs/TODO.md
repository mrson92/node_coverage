...
- [x] **IMP-001: 소스 선택 방식 개선** — 로컬 파일 선택/드래그앤드롭(`LocalFileUploader.tsx`), 언어 자동 판별(`utils/languageDetection.ts`), 실제 Git 저장소 연동(`/api/repo/*`)로 가상 스캔 구분. 진행 중 상태를 완료로 전환. `docs/EVIDENCE.md` IMP-001 참조. (2026-08-04 ~ IMP-005/006/007로 구현 완료)
